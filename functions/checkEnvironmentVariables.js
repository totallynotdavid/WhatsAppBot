...
function checkEnvironmentVariables() {
  ...
  const requiredVariables = ['spotify_client_id', 'spotify_client_secret', 'youtube_api_key', 'supabase_api_key', 'supabase_base_url', 'folder_id', 'facebook_access_token', 'facebookId', 'adminNumber', 'MUSIXMATCH_API_KEY', 'OPENAI_API_KEY'];
